...
//import com.nash.teacher.samples.AttributeExtension;
...
//                .bind("stockCount");
//
//        category.setItemCaptionGenerator(Checkout::getName);
...
//                viewLogic.saveBook(currentProduct);
//            }
//        });
//
//        discard.addClickListener(
//                event -> viewLogic.editBook(currentProduct));
//
//        cancel.addClickListener(event -> viewLogic.cancelProduct());
//
//        delete.addClickListener(event -> {
//            if (currentProduct != null) {
//                viewLogic.deleteBook(currentProduct);
//            }
//        });
//    }
//
//    public void setCategories(Collection<Checkout> categories) {
//        category.setItems(categories);
//    }
//
//    public void editProduct(Book product) {
//        if (product == null) {
//            product = new Book();
//        }

package com.nash.teacher.client.samples;
...
import com.nash.teacher.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@com.nash.teacher.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
